...
def instantiate_from_config(config):
    ...
    # cls:'PatchVQGAN' module:'image_synthesis.modeling.codecs.image_codec.patch_vqgan'
    # cls:'PatchEncoder2' module:'image_synthesis.modeling.codecs.image_codec.patch_vqgan'
    # ...
    # cls:'EdgeConnectLoss' modele:'image_synthesis.modeling.modules.edge_connect.losses'
    module, cls = config["target"].rsplit(".", 1)
    # cls:<class 'image_synthesis.modeling.codecs.image_codec.patch_vqgan.PatchVQGAN'>
    # cls:<class 'image_synthesis.modeling.codecs.image_codec.patch_vqgan.PatchEncoder2'>
    # ...
    # cls:<class 'image_synthesis.modeling.modules.edge_connect.losses.EdgeConnectLoss'>
